...
/**************************************************************************
 * jquery.themepunch.revolution.jslogin - jQuery Plugin for Revolution Slider
...
//							//container.parent().csslogin({'position':'absolute','width':jQuery(window).width()});
...
//													f.src = httpprefix+"://a.vimeocdn.com/jslogin/froogaloop2.min.js"; /* Load Player API*/
//													var before = document.getElementsByTagName("script")[0];
//
//													var loadit = true;
//													jQuery('head').find('*').each(function(){
//														if (jQuery(this).attr('src') == httpprefix+"://a.vimeocdn.com/jslogin/froogaloop2.min.js")
//														   loadit = false;
//													});
//													if (loadit)
...
//										jQuery(this).removeClass("video-jslogin").removeClass("vjs-default-skin");
...
//												//opt.container.parent().csslogin({'width':jQuery(window).width()});
...
//							else
//								var src=li.find("imglogin:first").attr('src');
//
//
...
//
//			container.find('>ul:first >li').each(function(i) {
//							var src=container.find(">ul:first >li:eq("+i+") imglogin:first").attr('src');
...
//
//
//			container.find('>ul:first >li >imglogin').each(function(j) {
//
//				var img=jQuery(this);
//
...
//					pari.find('.tp-bgimg').append('<imglogin class="ieeightfallbackimage defaultimg" src="'+src+'" style="width:100%">');
//				}
//
//
//
...
//							if (isIE(8)) {
//							   sh.find('.slot ').last().find('.slotslide').append('<imglogin class="ieeightfallbackimage" src="'+imgsrc+'" style="width:100%;height:auto">');
...
//						if (isIE(8)) {
//
//							sh.find('.slot ').last().find('.slotslide').append('<imglogin src="'+imgsrc+'">');
//							ieimgposition(sh,opt);
//						}
//
//						if (scalestart!=undefined && rotatestart!=undefined)
...
//
//			container.find('imglogin, .defaultimg').each(function(i) {
//				var img = jQuery(this);
//
...
//				opt.cd=0;
//				 var found = 0;
//				 element.find('imglogin, .defaultimg').each(function(i) {
...
//								video
//									.csslogin('top',0)
//									.csslogin('left',-(windowH*mediaAspect-windowW)/2)
//									.csslogin('height',windowH);			*/
//								
//
//						} else {
//							// wider
...
//									.height(windowW/mediaAspect);
//								video
//									.csslogin('top',-(windowW/mediaAspect-windowH)/2)
//									.csslogin('left',0)
//									.csslogin('height',windowW/mediaAspect);*/
//
//						}
//						
//						
...
//								    var imh = 0;
//
//									if (nextcaption.find('imglogin').length>0) {
//														var im = nextcaption.find('imglogin');
...
//	var errorMessage = "Revolution Slider Error: You have some jquery.jslogin library include that comes after the revolution files jslogin include.";
//	errorMessage += "<br> This includes make eliminates the revolution slider libraries, and make it not work.";
//	errorMessage += "<br><br> To fix it you can:<br>&nbsp;&nbsp;&nbsp; 1. In the Slider Settings -> Troubleshooting set option:  <strong><b>Put JS Includes To Body</b></strong> option to true.";
//	errorMessage += "<br>&nbsp;&nbsp;&nbsp; 2. Find the double jquery.jslogin include and remove it.";
