...
$solvedEtislat = 0;
$unsolvedEtislat = 0;
$id_unSolvedComplainsEtislat = array();
$id_SolvedComplainsEtislat = array();
...
<script>
    ...
    function actionComplainEtislat(d) {
    ...
    <ul id="comments-list" class="comments-list">
        <li>
            <?php for ($i = 0; $i < count($ComplainJson['complains']); $i++) { ?>
                <div class="comment-main-level">
                    <!-- Avatar -->
                    <?php if ($ComplainJson['complains'][$i]['operator'] == '3') {
                        $ComplainsEtislat++; ?>
        ...
        <?php } else {
            ...
            $id_unSolvedComplainsEtislat[] = $i; ?>
                       ...
                       <input type="submit" id="ResponseEtislatAnswer<?php echo $i; ?>" onclick="EtislatAnswer(<?php echo $i; ?>)" style="margin-left: 67px; margin-top: 12px" class="btn-success btn-lg" value="Response For Complain"/>
                                                    ...
                                                    <form method="post" style="" id="responseComplainer" class="form-group" role="form">
                                                        <div class="form-group">
                                                            ...
                                                            <table style="margin-left: 300px; margin-top: 10px;" class="table_complain_operator bd-r-left tabelComplains">
                                                                <tr>
                                                                    <td><input type="submit" id="btnSCEtislat<?php echo $i; ?>"  class="btn-success btn-lg" value="Send Complain" onclick="actionComplainEtislat(document.getElementsByName('ResponseAnswerComplain' + Comp)[0].value)"/></td>
                                                                    <td><input type="submit" id="btnCancelEtislat<?php echo $i; ?>" class="btn-success btn-lg" style="margin-left: 100px;" value="Cancel" onclick="actionComplainEtislat('')"/></td>
        ...
        <?php echo '</div>'; ?>
                                ...
                                <?php
//echo $ComplainsEtislat."<br/>";echo $solvedEtislat."<br/>";
                                $_SESSION['ComplainsEtislat'] = $ComplainsEtislat;
                                $_SESSION['solvedEtislat'] = $solvedEtislat;
                                $_SESSION['unsolvedEtislat'] = $unsolvedEtislat;
                                $_SESSION['id_unSolvedComplainsEtislat'] = $id_unSolvedComplainsEtislat;
                                $_SESSION['id_SolvedComplainsEtislat'] = $id_SolvedComplainsEtislat;
//var_dump($_SESSION['id_SolvedComplainsEtislat']);
//
                                $_SESSION['ProfileunsolvedComplain'] = $id_unSolvedComplainsEtislat;
                                $_SESSION['ProfilesolvedComplain'] = $id_SolvedComplainsEtislat;
                                ?>