...
$solvedMobinil = 0;
$unsolvedMobinil = 0;
$id_unSolvedComplainsMobinil = array();
$id_SolvedComplainsMobinil = array();
...
<script>
    ...
    function actionComplainMobinil(d) {
    ...
    <ul id="comments-list" class="comments-list">
        <li>
            <?php for ($i = 0; $i < count($ComplainJson['complains']); $i++) { ?>
                <div class="comment-main-level">
                    <!-- Avatar -->
                    <?php if ($ComplainJson['complains'][$i]['operator'] == '1') {
                        $ComplainsMobinil++; ?>
        ...
        <?php } else {
            ...
            $id_unSolvedComplainsMobinil[] = $i; ?>
                       ...
                       <input type="submit" id="ResponseMobinilAnswer<?php echo $i; ?>" onclick="MobinilAnswer(<?php echo $i; ?>)" style="margin-left: 67px; margin-top: 12px" class="btn-success btn-lg" value="Response For Complain"/>
                                                    ...
                                                    <form method="post" style="" id="responseComplainer" class="form-group" role="form">
                                                        <div class="form-group">
                                                            ...
                                                            <table style="margin-left: 300px; margin-top: 10px;" class="table_complain_operator bd-r-left tabelComplains">
                                                                <tr>
                                                                    <td><input type="submit" id="btnSCMobinil<?php echo $i; ?>"  class="btn-success btn-lg" value="Send Complain" onclick="actionComplainMobinil(document.getElementsByName('ResponseAnswerComplain' + Comp)[0].value)"/></td>
                                                                    <td><input type="submit" id="btnCancelMobinil<?php echo $i; ?>" class="btn-success btn-lg" style="margin-left: 100px;" value="Cancel" onclick="actionComplainMobinil('')"/></td>
        ...
        <?php echo '</div>'; ?>
                                ...
                                <?php
//echo $ComplainsMobinil."<br/>";echo $solvedMobinil."<br/>";
                                $_SESSION['ComplainsMobinil'] = $ComplainsMobinil;
                                $_SESSION['solvedMobinil'] = $solvedMobinil;
                                $_SESSION['unsolvedMobinil'] = $unsolvedMobinil;
                                $_SESSION['id_unSolvedComplainsMobinil'] = $id_unSolvedComplainsMobinil;
                                $_SESSION['id_SolvedComplainsMobinil'] = $id_SolvedComplainsMobinil;
//var_dump($_SESSION['id_SolvedComplainsMobinil']);
//
                                $_SESSION['ProfileunsolvedComplain'] = $id_unSolvedComplainsMobinil;
                                $_SESSION['ProfilesolvedComplain'] = $id_SolvedComplainsMobinil;
                                ?>