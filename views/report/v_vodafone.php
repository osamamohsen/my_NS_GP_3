...
function Response_OP_Vodafone(d) {
    ...
    function actionResponseVodafoneReport(d) {
        $("#Response_Report" + Div).slideToggle("slow");
        if (d !==''){
    ...
    function printingReportVodafone(d){
        alert(d);
...
<div id="ReportOperators" style="overflow-y: scroll; height: 635px;">
    <label id="assignValue"><?php echo $_SESSION['operator']; ?></label>
        ...
        <div id="ReportsCheck">
    <?php if ($J_R_O['reports'][$R_Op]['to'] == 2) { ?>    
        ...
        <?php echo $J_R_O['reports'][$R_Op]['notes']; ?>
                                    ...
                                    <td>
                                        <input type="submit" class="btn-primary btn-sm btn-report_operator" onclick="printingReportVodafone(<?php echo $eres; ?>)" style="float: right;display: block;" value="Print"/> 
                            <input type="submit" class="btn-primary btn-sm btn-report_operator" data-toggle="modal" data-target="#effect_op_Response" value="Replay" onclick="Response_OP_Vodafone(<?php echo $eres ?>)"/>
                            ...
                            <form method="post" style="" id="responseReporter" class="form-group" role="form">
                                <div class="form-group">
                                    ...
                                    <table style="margin-left: 300px; margin-top: 10px;" class="table_report_operator bd-r-left tabelReports">
                                        <tr>
                                            <td><input type="submit" id="btnSendResponse<?php echo $eres; ?>"  class="btn-success btn-lg" value="Send Report" onclick="actionResponseVodafoneReport(document.getElementsByName('txtRepsonseMessageOperator' + Div)[0].value)"/></td>
                                            <td><input type="submit" class="btn-success btn-lg" style="margin-left: 100px;" value="Cancel" onclick="actionResponseVodafoneReport('')"/></td>
