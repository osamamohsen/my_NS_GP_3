...
<script>
 ...
 function Response_OP_Mobinil(d) {
        document.getElementById('ReportText'+d).innerHTML=document.getElementById("txt_report_operators"+d).innerHTML;
    ...
    function printingReport(d){
        alert(d);
        var prtContent=document.getElementById("txt_report_operators"+d);
//        var  = document.getElementById("myContainersss");
    ...
    function actionResponseMobinilReport(d) {
        $("#Response_Report" + Div).slideToggle("slow");
        if (d !==''){
...
<div id="ReportOperators" style="overflow-y: scroll; height: 635px;">
    <label id="assignValue"><?php // echo $_SESSION['operator']; ?></label>
        ...
        <div id="ReportsCheck">
    <?php if ($J_R_O['reports'][$R_Op]['to'] == 1) { ?>    
                        ...
                        <td class="bd-r-left">
                            <table  class="bd-r-left" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 80%;"> 
                                        <p class='txt_report_operator' id='txt_report_operators<?php echo $eres; ?>' name="txtresponse<?php echo $eres; ?>">
        <?php echo $J_R_O['reports'][$R_Op]['notes']; ?>
                                        </p>
                                    </td>
                                    <td><input type="submit" onclick="printingReport(<?php echo $eres; ?>)" class="btn-primary btn-sm btn-report_operator" style="float: right;display: block;" value="Print"/>
                                    <input type="submit" class="btn-primary btn-sm btn-report_operator" data-toggle="modal" data-target="#effect_op_Response" value="Replay" onclick="Response_OP_Mobinil(<?php echo $eres ?>)"/></td>
                                </tr>
                            ...
                            <form method="post" style="" id="responseReporter" class="form-group" role="form">
                                <div class="form-group">
                                    <table class="table_report_operator bd-r-left tabelReports" style="width: 100%; margin-top: 10px;">
                                        <tr>
                                            ...
                                            <td style=" border-top: 3px solid #BCED91; border-right: 3px solid #BCED91;">
                                                <label id="ReportText<?php echo $eres; ?>" style="float: left; margin-left: 12px;" >osama</label></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table style="margin-left: 300px; margin-top: 10px;" class="table_report_operator bd-r-left tabelReports">
                                        <tr>
                                            <td><input type="submit" id="btnSendResponse<?php echo $eres; ?>"  class="btn-success btn-lg" value="Send Report" onclick="actionResponseMobinilReport(document.getElementsByName('txtRepsonseMessageOperator' + Div)[0].value)"/></td>
                                            <td><input type="submit" class="btn-success btn-lg" style="margin-left: 100px;" value="Cancel" onclick="actionResponseMobinilReport('')"/></td>
