...
.Tab-listOperatorNSPE .active, .Tab-listOperatorNSPE .active a {
    border-bottom: none;
/*    z-index: 10;*/
}
...
$(function () {
    ...
    //--------Tabs----------\\
    $(".Tab-listOperatorNSPE .tabOperatorNSPE1 a").click(function(e) {
        e.preventDefault();
        $(".tabOperatorNSPE-content .active").removeClass("active");
        $(".tabOperatorNSPE1").addClass("active");
        $("#OperatorNSPEE").attr("src","./resources/images/dropDown/EtislatColor.png");
        $("#OperatorNSPEV").attr("src","./resources/images/dropDown/VodafoneBlack.png"); 
        $("#OperatorNSPEM").attr("src","./resources/images/dropDown/MobinilBlack.png"); 

        //./resources/images/dropDown/VodafoneColor.png
        //OperatorNSPEE
    });
    
    $(".Tab-listOperatorNSPE .tabOperatorNSPE2 a").click(function(e) {
        e.preventDefault();
        $(".tabOperatorNSPE-content .active").removeClass("active");
        $(".tabOperatorNSPE2").addClass("active");
        
        $("#OperatorNSPEE").attr("src","./resources/images/dropDown/EtislatBlack.png");
        $("#OperatorNSPEV").attr("src","./resources/images/dropDown/VodafoneColor.png"); 
        $("#OperatorNSPEM").attr("src","./resources/images/dropDown/MobinilBlack.png"); 

    });
    
    $(".Tab-listOperatorNSPE .tabOperatorNSPE3 a").click(function(e) {
        e.preventDefault();
        $(".tabOperatorNSPE-content .active").removeClass("active");
        ...
        $("#OperatorNSPEE").attr("src","./resources/images/dropDown/EtislatBlack.png");
        $("#OperatorNSPEV").attr("src","./resources/images/dropDown/VodafoneBlack.png"); 
        $("#OperatorNSPEM").attr("src","./resources/images/dropDown/MobinilColor.png"); 
                                ...
                                <div class="tabs"> 
                                    ...
                                    <div class="tab-content">
                                        <div class="tab1 active">
                                            <p><?php include 'EtislatCallDrop.php'; ?></p>
                                        </div>
                                        <div class="tab3">
                                            <p><?php include 'EtislatCallBlock.php'; ?></p>
                                        </div>

                                        <div class="tab4">
                                            <p><?php include 'EtislatPoorCaverage.php'; ?></p>
                                        </div>

                                        <div class="tab5">
                                            <p><?php include 'EtislatSilentCall.php'; ?></p>
                                        </div>
<!--EtilsatSilentCall.php-->
                                        <div class="tab6">
                                            <p><?php include 'EtilsatCrossTalk.php'; ?></p>
                                        </div>
<!--EtislatCrossTalk.php-->
                                    </div><!-- end tab-content -->
                                ...
                                <div class="tabs">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab8 active">
                                            <p><?php include 'Etislat_NoService.php'; ?></p>
                                        </div>
                                        <div class="tab9">
                                            <p><?php include 'Etisalalt_noDataAccess.php'; ?></p>
                                        </div>

                                        <div class="tab10">
                                            <p><?php include 'Etislat_lowSpeed.php'; ?></p>
                                        </div>
