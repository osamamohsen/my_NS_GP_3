            ...
            <div class="orderTabel">
                ...
                <section class="table-box" style="height: 370px;">
                    <table class="order-table">
                        ...
                        <tbody>
                            <?php for ($d = 0; $d < count($MobinilNSPE['terminal_samples']); $d++) {
                            if($MobinilNSPE['terminal_samples'][$d]['event']==4 && $MobinilNSPE['terminal_samples'][$d]['network_type']==1){
                                ?>   
                                <tr>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['idterminal_samples']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['time']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['location_provider']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['longitude']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['latitude']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['signal_level']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['signal_quality']; ?> </td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['BER']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['speed']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['battary_level']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['cid']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['lac']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['msisdn']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['event']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['network_type']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['terminal_sim_sim_id']; ?></td>
                                    <td><?php echo $MobinilNSPE['terminal_samples'][$d]['battery_status']; ?></td>
