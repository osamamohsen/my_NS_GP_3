                ...
                <section class="table-box" style="height: 370px;">
                    <table class="order-table">
                       ...
                       <tbody>
                            ...
                            if($MobinilNSPE['ps_samples'][$d]['event']==2 && $MobinilNSPE['ps_samples'][$d]['msisdn']==1){
                                ?>   
                                <tr>
                                    ...
                                    <td><?php echo $MobinilNSPE['ps_samples'][$d]['signal_quality']; ?> </td>
                                    <td><?php echo $MobinilNSPE['ps_samples'][$d]['BER']; ?></td>
