...
<div class="container12" style="margin-top: -12px;">
    <div class="row">
        <div class="column7">
            <div class="TabNSPE_">
                <ul class="Tab-listNSPE">
                    <li class="tabNSPE1 active"><a href="#"><img id="NSPE_E" src="./resources/images/dropDown/EtislatBlack.png" class="operatoresImages"/></a></li>
                    <li class="tabNSPE2"><a href="#"><img id="NSPE_V" src="./resources/images/dropDown/VodafoneBlack.png" class="operatoresImages"/></</a></li>
                    <li class="tabNSPE3"><a href="#"><img id="NSPE_M" src="./resources/images/dropDown/MobinilBlack.png" class="operatoresImages"/></a></li>
                </ul>
