<html>
 ...
 for ($i = 0; $i < 9; $i++) {$events[$i]=0;} $solved=0;
    for ($i = 0; $i < count($json_Dis_complain['complains']); $i++) {
        if($json_Dis_complain['complains'][$i]['operator']==2){
...
//                V_chart
                ...
                var chart = new google.visualization.PieChart(document.getElementById('V_chart_div'));
                chart.draw(data, options);
                var chart2 = new google.visualization.PieChart(document.getElementById('V_chart_div2'));
                chart2.draw(data2, options2);
                var chart3 = new google.visualization.PieChart(document.getElementById('V_chart_div3'));
                chart3.draw(data3, options3);
                var chart4 = new google.visualization.PieChart(document.getElementById('V_chart_div4'));
    ...
    <body>
        ...
        <table style="width: 87%; margin-left: 145px;">
            <tr>
                ...
                <td style="float: left;">  <div id="V_chart_div"></div></td>
                <td><div id="V_chart_div2"></div></td>

            </tr>
            <tr>
                <td style="float: left;"><div id="V_chart_div3"></div></td> 
                <td style="margin-right: 30px; ">  <div id="V_chart_div4"></div></td>
